...
public class NoticeController extends BaseController
{
     ...
     * 查询公告管理列表
     */
    @PreAuthorize("@ss.hasPermi('qwk:notice:list')")
    @GetMapping("/list")
     ...
     * 导出公告管理列表
     */
    @PreAuthorize("@ss.hasPermi('qwk:notice:export')")
     ...
     * 获取公告管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('qwk:notice:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增公告管理
     */
    @PreAuthorize("@ss.hasPermi('qwk:notice:add')")
     ...
     * 修改公告管理
     */
    @PreAuthorize("@ss.hasPermi('qwk:notice:edit')")
     ...
     * 删除公告管理
     */
    @PreAuthorize("@ss.hasPermi('qwk:notice:remove')")
