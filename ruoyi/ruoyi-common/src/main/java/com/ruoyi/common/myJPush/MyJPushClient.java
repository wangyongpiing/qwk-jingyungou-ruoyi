package com.ruoyi.common.myJPush;
/**
 * @Description:
 * @author cjf
 * @date 2023-09-01
...
public class MyJPushClient {
     ...
     * @param extras            扩展字段
     */
    public void sendToAliasList(List<String> alias, String notificationTitle, String msgTitle, String msgContent, HashMap<String, Object> extras) {
     ...
     * @param extras        扩展字段
     */
    public void sendToAll(String notificationTitle, String msgTitle, String msgContent, HashMap<String, Object> extras) {
     ...
     * @return
     */
    public PushPayload buildPushObject_android_and_ios(String notificationTitle, String msgTitle, String msgContent, HashMap<String, Object> extras) {
        return PushPayload.newBuilder()
                ...
                .setNotification(Notification.newBuilder()
                        ...
                        .addPlatformNotification(AndroidNotification.newBuilder()
                                ...
                                .addExtra("id", extras.containsKey("id") ? extras.get("id").toString(): "")
                                .addExtra("type", extras.containsKey("type") ? extras.get("type").toString(): "")
                                .build()
                        )
     ...
     * @return
     */
    private PushPayload buildPushObject_all_aliasList_alertWithTitle(List<String> aliasList, String notificationTitle, String msgTitle, String msgContent, HashMap<String, Object> extras) {
