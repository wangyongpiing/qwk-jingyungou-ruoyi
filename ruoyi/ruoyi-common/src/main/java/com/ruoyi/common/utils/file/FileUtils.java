...
public class FileUtils
{
    ...
    public static String getFileSize(String fileName){
        ...
        Double fileSizeKB =(fileSizeBytes.doubleValue() / 1024)/1024 ;
        BigDecimal two = new BigDecimal(fileSizeKB);
        Double doubleValue = two.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
//        System.out.println("文件大小为：" + two.setScale(2,BigDecimal.ROUND_HALF_UP).doubleValue() + "MB");
