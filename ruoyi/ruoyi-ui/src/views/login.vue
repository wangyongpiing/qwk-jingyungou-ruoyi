<template>
  <div class="login">
    ...
    <div class="el-login-footer">
      <span>Copyright © 2023. 湖北仟万客网络科技有限公司 All rights reserved.</span>
    </div>
...
<!--      承载二维码容器-->
      <wxlogin href='data:text/css;base64,LmltcG93ZXJCb3ggLnFyY29kZSB7CiAgICB3aWR0aDogMTUwcHg7Cn0KLmltcG93ZXJCb3ggLnRpdGxlIHsKICAgIHRleHQtYWxpZ246IGxlZnQ7CiAgICBmb250LXNpemU6IDE2cHg7CiAgICBmb250LXdlaWdodDogYm9sZDsKfQ=='
               id="wxcode" theme='' appid="wx87d59d18b9f0b3fb" scope="snsapi_login" :redirect_uri="redirect_uri">
      </wxlogin>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        redirect_uri:"http://28rg2i.natappfree.cc/login",
        codeUrl: "",
        loginForm: {
          username: "",
          password: "",
