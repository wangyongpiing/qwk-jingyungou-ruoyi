<template>
  <div class="app-container">
    ...
    <el-row :gutter="20">
      <el-col :span="2.5">
        <div>
          <el-button type="warning">人民币换积分</el-button>
        </div>
      </el-col>
      <el-col :span="2.5">
        <div>
    ...
    <el-form ref="form" :model="form" :rules="rules"  style="padding-top: 20px">
      ...
      <el-form-item label="人民币兑换积分比例" prop="unrealProportion">
        <el-row>
          <el-col :span="3">
            <el-input v-model="form.moneyProportion" :disabled="true" placeholder="请输入现金占比"/>
          </el-col>
          <el-col :span="1" style="text-align:center;">
            <span >:</span>
          </el-col>
          <el-col :span="3">
            <el-input v-model="form.unrealProportion" placeholder="请输入积分占比"/>
          </el-col>
        </el-row>
      </el-form-item>
